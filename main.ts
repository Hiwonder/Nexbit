...
namespace nexbit {
    ...
    /**
     * Nexbit board initialization, please execute at boot time
    */
    //% weight=100 blockId=nexbitInit block="Initialize Nexbit"
    export function nexbitInit() {
        initRGBLight();
        // initColorSensor();
        serial.redirect(
            SerialPin.P12,
    ...
    */
    ...
    //% weight=90 blockId=line_followers blockGap=50 block="Line follower %lineFollowerSensor in %lineColor ?"
